...
resource "aws_glue_crawler" "rental_market_analysis" {
    ...
    role = "arn:aws:iam::126751535369:role/LabRole"
    database_name = "rental-market-database"

    s3_target {
      path = "s3://group4-enrich-data-zoneify/job2/"
    }
    tags = {
...
configuration {
    result_configuration {
        output_location = "s3://group4-enrich-data-zoneify/queryresults"
    }
  }
}