...
df_rds_new = spark.read.parquet('s3://group4-raw-data-zoneify/job1/')

df = spark.read.format('csv').options(sep=",", escape='"', mode="PERMISSIVE", header=True, multiLine=True).load('s3://group4-raw-data-zoneify/total_data.csv')
...
output_path = "s3://group4-enrich-data-zoneify/job2/"
